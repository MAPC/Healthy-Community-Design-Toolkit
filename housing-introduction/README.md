...
_Taylor, Lauren. \(June, 2018\). Housing And Health: An Overview Of The Literature. Health Affairs. Retrieved from:_ [NextPlanning & Assessment](https://app.gitbook.com/@hcdtk/s/stable-healthy-and-quality-homes/~/drafts/-Ma4_kLQNDSX0DVtyz7M/housing-introduction/planning-and-assessment)
{% endtab %}
{% endtabs %}
